...
<head>
    ...
    <title>Nouvelle session disponible</title>
    <style>
...
<table class="email-wrapper" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
    ...
    {{-- HERO --}}
    <tr>
        <td align="center" style="background:linear-gradient(145deg,#7a4a05 0%,#aa6808 45%,#d1922f 100%);padding:48px 40px 40px;">
            ...
            <p style="margin:0;font-size:14px;color:rgba(255,255,255,0.85);line-height:1.5;">
                La masterclass que vous attendiez vient d'ouvrir de nouvelles places
            </p>
        </td>
    </tr>
    ...
    <tr>
        <td class="email-body" style="padding:36px 40px 28px;">
            ...
            <p style="margin:0 0 24px;font-size:14px;line-height:1.8;color:#555;font-family:Arial,sans-serif;">
                Vous étiez sur liste d'attente pour la masterclass <strong style="color:#1a1a1a;">{{ $masterclass->title }}</strong>.
                Une <strong>nouvelle session vient d'être ajoutée</strong> — les inscriptions sont désormais ouvertes.
            </p>
                ...
                <tr>
                    <td style="padding:22px 24px;">
                        <p style="margin:0 0 4px;font-size:11px;font-family:Arial,sans-serif;color:#aa6808;letter-spacing:1.5px;text-transform:uppercase;font-weight:700;">
                            {{ $masterclass->niveau }} — Nouvelle session
                        </p>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td width="20" valign="top"><span style="font-size:14px;">👥</span></td>
                                <td style="padding-left:8px;font-size:13px;color:#6b5135;font-family:Arial,sans-serif;">
                                    {{ $session->max_participants }} places disponibles
                                </td>
                            </tr>
                            @endif
                            <tr><td colspan="2" style="height:8px;"></td></tr>
                ...
                <tr>
                    <td align="center">
                        <a href="{{ route('masterclass.show', $masterclass->slug) }}"
                            ...
                            Voir la session &amp; m'inscrire &nbsp;→
                        </a>
                    </td>
                </tr>
            </table>

            <p style="margin:0;font-size:12px;color:#bbb;text-align:center;font-family:Arial,sans-serif;">
