...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { title: 'Nouveau membre', href: route('admin.team-members.create') }
];
...
onMounted(() => {
    if (editorRef.value) {
        editor = new Quill(editorRef.value, {
            ...
            placeholder: 'Ajoutez une biographie pour ce membre d\'équipe...'
        });
    }
});
...
<template>
    <Head title="Ajouter un membre d'équipe" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-white shadow-sm">
            <!-- En-tête avec style amélioré -->
            <div class="flex justify-between items-center border-b pb-4">
                <h2 class="text-2xl font-bold text-gray-800">Ajouter un membre d'équipe</h2>
                <Link
            ...
            <form @submit.prevent="submit" class="space-y-6 max-w-4xl mx-auto">
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-md">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">Remplissez tous les champs nécessaires pour ajouter un nouveau membre à votre équipe.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-6 border-t">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Enregistrement...' : 'Enregistrer le membre' }}
                    </button>
