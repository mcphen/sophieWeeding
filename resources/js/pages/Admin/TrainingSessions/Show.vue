    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-white shadow-sm">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 border-b pb-6">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Détails de la formation</h2>
                </div>
...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { title: props.trainingSession.title, href: route('admin.training-sessions.show', props.trainingSession.id) }
];
