...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { title: 'Nouveau produit', href: route('admin.products.create') }
];
            ...
            <form @submit.prevent="submit" class="space-y-6 max-w-4xl mx-auto">
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-md">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">Remplissez tous les champs nécessaires pour ajouter un nouveau produit à votre catalogue.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Prix -->
                        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                            <label for="price" class="block text-sm font-medium text-gray-700 mb-2">Prix (CFA) <span class="text-red-600">*</span></label>
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    min="0"
                                    class="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
...
<!--                        </div>-->
                ...
                <div class="flex gap-3 pt-6 border-t">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Enregistrement...' : 'Enregistrer le produit' }}
                    </button>
