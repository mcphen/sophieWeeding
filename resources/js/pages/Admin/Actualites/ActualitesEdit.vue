...
// Formulaire Inertia avec données existantes
const form = useForm({
...
onMounted(() => {
    if (editorRef.value) {
        ...
        editor.root.innerHTML = props.actualite.description || '';
    }
});
...
function handleImageUpload(event: Event) {
    ...
    if (file) {
        ...
        form.image = null;
        // Ne pas réinitialiser imagePreview car cela pourrait être l'image existante
    }
}
            ...
            <form @submit.prevent="submit" class="space-y-6 max-w-4xl mx-auto">
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-md">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">Vous pouvez modifier les informations de cette actualité.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Image -->
                        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Image de l'actualité</label>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                        <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Description de l'actualité</label>
                ...
                <div class="flex gap-3 pt-6 border-t">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Enregistrement...' : 'Mettre à jour l\'actualité' }}
                    </button>
