...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { title: 'Nouveau service', href: route('admin.services.create') }
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-white shadow-sm">
            ...
            <div class="flex justify-between items-center border-b pb-4">
                <h2 class="text-2xl font-bold text-gray-800">Ajouter un service</h2>
                <Link
            ...
            <form @submit.prevent="submit" class="space-y-6 max-w-4xl mx-auto">
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-md">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">Remplissez tous les champs nécessaires pour créer un nouveau service.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-6 border-t">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Enregistrement...' : 'Enregistrer le service' }}
                    </button>
