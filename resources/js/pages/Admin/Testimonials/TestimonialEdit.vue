...
const breadcrumbs: BreadcrumbItemType[] = [
    ...
    { title: 'Modifier le témoignage', href: route('admin.testimonials.edit', props.testimonial.id) }
];

// Formulaire Inertia
const form = useForm({
    author_name: props.testimonial.author_name,
    author_title: props.testimonial.author_title || '',
...
const imagePreview = ref<string | null>(props.testimonial.image_path ? `/storage/${props.testimonial.image_path}` : null);
...
onMounted(() => {
    if (editorRef.value) {
        ...
        // Définir le contenu initial de l'éditeur
        editor.root.innerHTML = props.testimonial.content;
    }
});
...
function handleImageUpload(event: Event) {
    ...
    if (file) {
        ...
        form.image = null;
        // Ne pas effacer l'aperçu de l'image existante si aucun nouveau fichier n'est sélectionné
    }
}
...
<template>
    <Head title="Modifier un témoignage" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-white shadow-sm">
            <!-- En-tête avec style amélioré -->
            <div class="flex justify-between items-center border-b pb-4">
                <h2 class="text-2xl font-bold text-gray-800">Modifier un témoignage</h2>
                <Link
            ...
            <form @submit.prevent="submit" class="space-y-6 max-w-4xl mx-auto">
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-md">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">Modifiez les informations du témoignage selon vos besoins.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-6 border-t">
                    ...
                    >
                        ...
                        {{ form.processing ? 'Enregistrement...' : 'Mettre à jour le témoignage' }}
                    </button>
