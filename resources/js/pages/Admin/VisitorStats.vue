...
const breadcrumbs: BreadcrumbItem[] = [
    {
        ...
        href: route('admin.visitor-stats'),
    },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs" :logoUrl="logoUrl">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gray-50 dark:bg-gray-900">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <!-- Recent Appointments -->
                <div class="rounded-xl border border-border bg-blue-50 p-5 shadow-md dark:bg-blue-900/20">
                ...
                <!-- Recent Contacts -->
                <div class="rounded-xl border border-border bg-purple-50 p-5 shadow-md dark:bg-purple-900/20">
            ...
            <!-- Time Series Chart -->
            <div class="h-80 rounded-xl border border-border bg-green-50 p-5 shadow-md dark:bg-green-900/20">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div class="h-80 rounded-xl border border-border bg-amber-50 p-5 shadow-md dark:bg-amber-900/20">
                ...
                <div class="h-80 rounded-xl border border-border bg-teal-50 p-5 shadow-md dark:bg-teal-900/20">
            ...
            <!-- Geographical Data -->
            <div class="grid gap-6 md:grid-cols-2">
                <div class="h-80 rounded-xl border border-border bg-indigo-50 p-5 shadow-md dark:bg-indigo-900/20">
                ...
                <div class="h-80 rounded-xl border border-border bg-pink-50 p-5 shadow-md dark:bg-pink-900/20">
            ...
            <!-- Hourly Distribution -->
            <div class="h-80 rounded-xl border border-border bg-orange-50 p-5 shadow-md dark:bg-orange-900/20">
